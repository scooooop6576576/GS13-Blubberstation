	...
	borg_skins |= list(
		...
		*/
		...
		"Dragon" = list(
			...
			SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUEPANEL, TRAIT_R_HAS_UNIQUE_RESTING_LIGHTS, /*GS13 EDIT, LET BORGS BE BIG: TRAIT_R_EXPANDER_BLOCKED*/, TRAIT_R_BIG)
		),
	)
