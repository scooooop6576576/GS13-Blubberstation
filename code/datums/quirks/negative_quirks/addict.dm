/datum/quirk/item_quirk/addict
	...
	var/process_interval = 30 MINUTES //! how frequently the quirk processes	// GS13 EDIT every 30 seconds? are you nuts?
...
/datum/quirk/item_quirk/addict/add_unique(client/client_source)
	...
	for(var/addiction in reagent_instance.addiction_types)
		human_holder.last_mind?.add_addiction_points(addiction, 610)	// GS13 EDIT let's JUUUUST barely scrape the addiction trigger threshold
...
/datum/quirk/item_quirk/addict/process(seconds_per_tick)
	...
	if(deleted || missing_addiction)
		...
		for(var/addiction in reagent_instance.addiction_types)
			human_holder.last_mind?.add_addiction_points(addiction, 610) ///Max that shit out	// GS13 EDIT: yeah maybe not.
